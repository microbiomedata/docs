...
- **If a single-end or interleaved sample includes multiple FASTQ files** (e.g., from multiple sequencing lanes or runs), list all files **comma-separated**:
   ```
   file1.fastq.gz, file2.fastq.gz, file3.fastq.gz
   ```
